<template>
  <main>
    <div class="flex">
      <div>
        <img src="@/assets/img/vivit_icon.jpg" width="300px"/>
      </div>
      <div>
        <table>
          <tr><td>名前</td><td>土井ヴぃ(どいゔぃ)<br/>vivit（びびっと）<br/>vivit_jc（びびっとじぇーしー）</td></tr>
          <tr><td>mail</td><td>kazyu.vanilla@gmail.com</td></tr>
    ...
    <p>
        Twitterクライアントが使用不可になったことでTwitterを利用し続けることに限界を感じ、こちらに引っ越しました。(2023.2.14)
    </p>
  </main>
</template>
